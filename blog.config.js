...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jake', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || "I'm a sporty Chinese iOS dev who loves coding and electronics. Let's build something amazing!", // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tkey.ioser.store', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'TKey, Tesla, Tesla Key, Tesla Keyfob', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jakey_yang@hotmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '@joybook_jake', // 你的twitter个人主页
