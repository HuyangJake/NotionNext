const CONFIG_HEXO = {
  ...
  HOME_BANNER_GREETINGS: ['Hi，TKey is a Tesla Key App', 'Hi，Tkey is a Offline BLE Tesla Key', 'Hi，Tkey is a safe and multifunctional Tesla Key App', 'Welcome to the Tkey’s Site🎉'], // 首页大图标语文字
